...
function ItemDetailComponer(){
    ...
    return(
        <div>
            <ItemDetail nombreTorta = {detallesTortas.nombre} imagenTorta = {detallesTortas.imagen} descripcionTorta ={detallesTortas.descripcion} precio = {detallesTortas.precio} idTorta={detallesTortas.id} />
        </div>
    )
}
